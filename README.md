# Simple Spam Bot :robot:
Hi everybody :wave:

Hope you doing well :blush:

This `python` script will help you to spam in socials like Telegram, Whatsapp, ....
...
<img src="./images/sample.gif" style="border-radius:10px;box-shadow:5px 5px 5px;">
